...
const pages = {
  ...
  '/use-cases': ['AI & Data Use Cases by Industry | Zigo Business', 'Explore 45 practical AI and data use cases for financial services, insurance, public sector, energy and utilities, and retail, organised by delivery horizon.'],
