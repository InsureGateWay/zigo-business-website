...
const pages = {
  ...
  '/services/ai-services': ['Enterprise AI Implementation Services | Zigo Business', 'Assess, secure, deploy, integrate and operate Microsoft Copilot, ChatGPT and other enterprise AI platforms with Zigo Business Solutions.'],
  '/services/microsoft-copilot': ['Microsoft Copilot Consulting & Adoption Nigeria | Zigo Business', 'Get more value from Microsoft Copilot with readiness, security, deployment, Copilot Studio, integration, training and managed support.'],
  ...
  '/partners': ['Enterprise Technology Delivery Partnerships | Zigo Business', 'Extend your delivery capability across enterprise AI, Microsoft technologies, data engineering, analytics, cloud and systems integration with Zigo.'],
