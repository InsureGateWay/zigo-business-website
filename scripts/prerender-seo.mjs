...
const pages = {
  '/': ['Enterprise Data, AI & Cloud Solutions in Nigeria | Zigo Business', 'Zigo Business Solutions helps Nigerian and African enterprises use data, AI, cloud, cybersecurity and digital platforms to solve practical business challenges.'],
  ...
  '/services/ai-services': ['Enterprise AI Services & Automation | Zigo Business', 'Adopt practical, responsible AI with strategy, intelligent automation, machine learning and generative AI services designed around measurable business needs.'],
