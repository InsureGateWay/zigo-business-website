...
const pages = {
  ...
  '/use-cases': ['AI & Data Use Cases by Industry | Zigo Business', 'Explore 45 practical AI and data use cases for financial services, insurance, public sector, energy and utilities, and retail, organised by delivery horizon.', 'CollectionPage'],
  ...
  '/services/ai-services': ['Enterprise AI Implementation Services | Zigo Business', 'Assess, secure, deploy, integrate and operate enterprise AI platforms selected around your organisation’s data, systems, governance and business requirements.', 'Service'],
  ...
  '/partners': ['Partner With Zigo | Enterprise Technology Delivery', 'Add focused enterprise AI, data engineering, integration and application expertise to client engagements through accountable delivery work packages.', 'WebPage'],
