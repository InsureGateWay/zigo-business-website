  ...
  const products = [
    {
      ...
      description: "Comprehensive network security for enterprise environments",
      features: [
    ...
    },
    {
      ...
      title: "Data Protection Platform",
    ...
    },
    {
      ...
      description: "Enterprise compliance management and governance solutions",
      features: [
  ...
  const benefits = [
    {
      ...
      description: "Comprehensive security for all your assets"
    },
    {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/80 max-w-xl font-light mb-6">
                Comprehensive security suite designed to protect your enterprise from evolving threats. From network security to compliance, we've got you covered.
              </p>
              <Link to="/contact">
            ...
            <div className="hidden lg:flex justify-center">
              <div className="relative w-80 h-80">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <Shield className="w-32 h-32 text-white/90" strokeWidth={1} />
                </div>
                ...
                <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-[#ECD5AB] rounded-xl flex items-center justify-center shadow-lg">
                  <AlertTriangle className="w-8 h-8 text-[#7D582E]" />
                </div>
                <div className="absolute top-1/2 -right-8 -translate-y-1/2 w-16 h-16 bg-[#ECD5AB] rounded-xl flex items-center justify-center shadow-lg">
                  <FileCheck className="w-8 h-8 text-[#7D582E]" />
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-light text-gray-900 mt-4 mb-4">
              Comprehensive <span className="font-bold text-[#7D582E]">Security Suite</span>
            </h2>
            <p className="text-gray-500 text-lg font-light">
              Enterprise-grade security products for modern threats
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-light text-gray-900 mb-4">
              Why Choose Our <span className="font-bold text-[#7D582E]">Security Suite</span>
            </h2>
            <p className="text-gray-500 text-lg font-light">
      ...
      <div className="relative bg-gradient-to-r from-[#7D582E] to-[#a87a4a] py-20 px-6">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-white/80 mb-8 font-light">
            Let's discuss how our security suite can protect your business
          </p>
          <Link to="/contact">
