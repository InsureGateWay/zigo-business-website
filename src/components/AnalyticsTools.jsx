...
function AnalyticsTools() {
  ...
  const products = [
    {
      ...
      description: "Advanced BI tools for data visualization and reporting",
      features: [
    ...
    },
    {
      ...
      description: "AI-powered predictive analytics for better decision-making",
      features: [
    ...
    },
    {
      ...
      description: "High-performance analytics for real-time data processing",
      features: [
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Instant access to critical business metrics"
    },
    {
      icon: <Lightbulb className="w-6 h-6" />,
      title: "Predictive Capabilities",
      description: "Anticipate trends and opportunities"
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Collaborative Analytics",
      description: "Team-friendly tools for shared insights"
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/80 max-w-xl font-light mb-6">
                Comprehensive analytics tools that turn your data into actionable insights. From BI to predictive analytics, we provide the tools you need.
              </p>
              <Link to="/contact">
            ...
            <div className="hidden lg:flex justify-center">
              <div className="relative w-80 h-80">
                ...
                <div className="absolute top-1/2 -right-8 -translate-y-1/2 w-16 h-16 bg-[#ECD5AB] rounded-xl flex items-center justify-center shadow-lg">
                  <Gauge className="w-8 h-8 text-[#7D582E]" />
                </div>
                <div className="absolute top-1/2 -left-8 -translate-y-1/2 w-16 h-16 bg-[#ECD5AB] rounded-xl flex items-center justify-center shadow-lg">
                  <LineChart className="w-8 h-8 text-[#7D582E]" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-light text-gray-900 mt-4 mb-4">
              Advanced <span className="font-bold text-[#7D582E]">Analytics Tools</span>
            </h2>
            <p className="text-gray-500 text-lg font-light">
              Comprehensive analytics tools for data-driven enterprises
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-light text-gray-900 mb-4">
              Why Choose Our <span className="font-bold text-[#7D582E]">Analytics Tools</span>
            </h2>
            <p className="text-gray-500 text-lg font-light">
              Enterprise-grade analytics for every business need
            </p>
          </div>
      ...
      <div className="relative bg-gradient-to-r from-[#7D582E] to-[#a87a4a] py-20 px-6">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-white/80 mb-8 font-light">
            Let's discuss how our analytics tools can transform your business
          </p>
          <Link to="/contact">
