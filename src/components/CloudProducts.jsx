  ...
  const products = [
    {
      ...
      description: "Unified hybrid cloud management for on-premise and cloud environments",
      features: [
    ...
    },
    {
      ...
      description: "Comprehensive cloud infrastructure products for enterprise needs",
      features: [
    ...
    },
    {
      ...
      description: "Managed database solutions across multiple cloud platforms",
      features: [
    ...
    },
    {
      ...
      description: "Enterprise-grade security for cloud environments",
      features: [
  ...
  const benefits = [
    {
      ...
      description: "Solutions that scale with your business needs"
    },
    {
    ...
    },
    {
      ...
      description: "Efficient cloud resource management"
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/80 max-w-xl font-light mb-6">
                Enterprise cloud products designed for modern businesses. From infrastructure to security, we provide comprehensive cloud solutions.
              </p>
              <Link to="/contact">
            ...
            <div className="hidden lg:flex justify-center">
              <div className="relative w-80 h-80">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <Cloud className="w-32 h-32 text-white/90" strokeWidth={1} />
                </div>
                ...
                <div className="absolute top-1/2 -right-8 -translate-y-1/2 w-16 h-16 bg-[#ECD5AB] rounded-xl flex items-center justify-center shadow-lg">
                  <Lock className="w-8 h-8 text-[#7D582E]" />
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-light text-gray-900 mt-4 mb-4">
              Comprehensive <span className="font-bold text-[#7D582E]">Cloud Products</span>
            </h2>
            <p className="text-gray-500 text-lg font-light">
              End-to-end cloud solutions for modern enterprises
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-light text-gray-900 mb-4">
              Why Choose Our <span className="font-bold text-[#7D582E]">Cloud Products</span>
            </h2>
            <p className="text-gray-500 text-lg font-light">
              Enterprise-grade cloud solutions for every need
            </p>
          </div>
      ...
      <div className="relative bg-gradient-to-r from-[#7D582E] to-[#a87a4a] py-20 px-6">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-white/80 mb-8 font-light">
            Let's discuss how our cloud products can transform your business
          </p>
          <Link to="/contact">
